...
def menu():
    ...
    lodhirt()
    print
    print 'AUTHOR   : SAQIB MEHMOOD'
    print 'FACEBOOK : facebook.com/Haji.sahab2'
    print 'GITHUB     : github.com/USTAAD786'
    
    jaalan('\x1b[1;91m[\x1b[1;92m1\x1b[1;91m]  \x1b[1;93mNDIAN 6 DIGIT CLONE')
    print
    action()
...
def action():
    ...
    if bch == '':
        ...
        os.system('xdg-open https://www.facebook.com/Haji.sahab2')
        time.sleep(1)
        menu()
    elif bch == '12':
        os.system('xdg-open https://www.facebook.com/Haji.sahab2')
